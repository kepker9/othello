...
/**
 * Square class represents a single board tile in the Othello grid. Squares can change color to indicate
 * possible moves or its border state.
 */
public class Square {
